...
define(['config/App', 'base/BaseController'], function (app, BaseController) {
    ...
    var HomeController = BaseController.extend({
        ...
        showContactModal: function () {
            ...
            this.showModal('templates/contact.html', { scope: sc }).then(function () {
                //Mail Gonder
        ...
        init: function (bundle, security, email) {
            this._super(bundle);
            this.security = security;
            this.email = email;
            //
            //this.security.checkApp();
        },
        ...
        extendScope: function () {
            ...
            this.scope.showContactModal = this.showContactModal.bind(this);
    ...
    //Register
    app.addController('HomeController', HomeController, ['Security', 'Email']);
});
